...
(
	...
	.rstin         (~rst_n             ),// reset
	.blue_din      (o_rgb[7:0]           ),// Blue data in
	.green_din     (o_rgb[15:8]            ),// Green data in
	.red_din       (o_rgb[23:16]            ),// Red data in
	.hsync         (o_hsync           ),// hsync data
	.vsync         (o_vsync           ),// vsync data
	.de            (o_de         ),// data enable
